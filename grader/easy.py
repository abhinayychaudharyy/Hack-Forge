"""
AeroSync AI — Easy Task Grader
================================
Difficulty: 1 / 3
Weights: completion=0.60, efficiency=0.15, safety=0.10, priority=0.05, drone_quality=0.10
...
def grade(state: Dict[str, Any]) -> float:
    """
    Grade a completed (or timed-out) easy-difficulty episode.
